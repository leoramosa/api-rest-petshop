# Generated by Django 3.0.8 on 2021-01-05 22:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iconcategory', models.ImageField(blank=True, null=True, upload_to='productos')),
            ],
            options={
                'db_table': 'categoria',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad', models.IntegerField(blank=True, db_column='NumTalla', null=True)),
                ('state', models.BooleanField(blank=True, default=True, null=True)),
                ('colorproducto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='servicios.Color')),
            ],
        ),
        migrations.CreateModel(
            name='Province',
            fields=[
                ...
                ('delivery', models.BooleanField(blank=True, default=True, null=True)),
                ('costo', models.IntegerField(blank=True, null=True)),
                ('tienda', models.BooleanField(blank=True, default=True, null=True)),
