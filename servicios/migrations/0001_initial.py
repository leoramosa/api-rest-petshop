# Generated by Django 3.0.8 on 2020-08-07 06:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photoprincipal', models.ImageField(blank=True, upload_to='productos')),
                ('fotosproducts1', models.ImageField(blank=True, upload_to='productos')),
                ('fotosproducts2', models.ImageField(blank=True, upload_to='productos')),
                ('fotosproducts3', models.ImageField(blank=True, upload_to='productos')),
                ('fotosproducts4', models.ImageField(blank=True, upload_to='productos')),
                ('imagen', models.CharField(blank=True, max_length=200, null=True)),
