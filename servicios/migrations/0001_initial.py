...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nomcolor', models.CharField(blank=True, db_column='nomColor', max_length=60, null=True)),
                ('numcolor', models.CharField(blank=True, db_column='numColor', max_length=60, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagencolor', models.CharField(blank=True, db_column='imgcolor', max_length=60, null=True)),
                ('imagennumbercolor', models.CharField(blank=True, db_column='imgnumberColor', max_length=60, null=True)),
                ('value', models.CharField(blank=True, db_column='numvaluecolor', max_length=60, null=True)),
                ('imagencolor1', models.ImageField(blank=True, null=True, upload_to='colorimagen')),
                ('imagencolor2', models.ImageField(blank=True, null=True, upload_to='colorimagen')),
                ('imagencolor3', models.ImageField(blank=True, null=True, upload_to='colorimagen')),
                ('imagencolor4', models.ImageField(blank=True, null=True, upload_to='colorimagen')),
                ('imagencolor5', models.ImageField(blank=True, null=True, upload_to='colorimagen')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photoprincipal', models.ImageField(blank=True, null=True, upload_to='productos')),
                ('fotosproducts1', models.ImageField(blank=True, null=True, upload_to='productos')),
                ('fotosproducts2', models.ImageField(blank=True, null=True, upload_to='productos')),
                ('fotosproducts3', models.ImageField(blank=True, null=True, upload_to='productos')),
                ('fotosproducts4', models.ImageField(blank=True, null=True, upload_to='productos')),
                ('fotosproducts5', models.ImageField(blank=True, null=True, upload_to='productos')),
                ('fotosproducts6', models.ImageField(blank=True, null=True, upload_to='productos')),
                ('fotosproducts7', models.ImageField(blank=True, null=True, upload_to='productos')),
                ('cantidadstock', models.CharField(blank=True, db_column='CantidadStock', max_length=18, null=True)),
                ...
                ('brevedescripcion', models.CharField(blank=True, db_column='breveDescripcion', max_length=200, null=True)),
